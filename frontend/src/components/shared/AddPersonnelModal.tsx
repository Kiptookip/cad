        ...
        <div className="bg-gradient-to-r from-[#1a2327] via-[#1e293b] to-[#1a2327] p-8 flex justify-between items-center border-b border-brand-teal/20">
          <div className="flex items-center gap-5">
            <div className="bg-brand-green shadow-[0_0_20px_rgba(136,194,65,0.4)] p-3 rounded-2xl">
              <UserPlus size={32} weight="fill" className="text-[#1a2327]" />
            </div>
            <div>
              <h3 className="text-white font-sans text-2xl font-black uppercase tracking-tight leading-none mb-1">Personnel Enlistment</h3>
              <div className="flex items-center gap-2">
                <span className="w-2 h-2 rounded-full bg-brand-green animate-pulse"></span>
                <p className="text-brand-green text-[10px] font-black uppercase tracking-[0.25em]">Secure Terminal: Identity-Alpha</p>
              </div>
            </div>
          </div>
          <button 
